...
class Card_deck:
    """Structure to store information about playing card deck."""
...
def deck_init():
    ...
    for Suit in ['Spades','Diamonds','Clubs','Hearts']: 
       for Rank in ['Ace','Two','Three','Four','Five','Six','Seven',
              ...
              deck[Rank+Suit] = 0             
              #deck.append(Card_deck(Rank,Suit))
...
def create_card(rank_img, suit_img):
    """Uses contour to find information about the query card. Isolates rank
    and suit images from the card."""
    ...
    qCard.suit_img = suit_img
    qCard.rank_img = rank_img
...
def match_card(qCard, train_ranks, train_suits):
    ...
    if (len(qCard.rank_img) != 0) and (len(qCard.suit_img) != 0):
        ...
        # cv2.imshow("Card_rank_img",qCard.rank_img)
        # cv2.imshow("Card_suit_img",qCard.suit_img)

        # cv2.resizeWindow("Card_rank_img", 300, 125)
        # cv2.moveWindow("Card_rank_img", 1000, 200)

        # cv2.resizeWindow("Card_uit_img", 300, 125)
        # cv2.moveWindow("Card_suit_img", 1000, 400)
        ...
        for Trank in train_ranks:
                ...
                # cv2.imshow("Trank_img", Trank.img)
                # cv2.resizeWindow("diff_img", 300, 125)
                # cv2.moveWindow("diff_img", 600, 600)
                # cv2.resizeWindow("Trank_img", 300, 125)
                # cv2.moveWindow("Trank_img", 600, 800)
                # cv2.waitKey(1)
        ...
        # cv2.imshow("Card_best_rank_match_diff", best_rank_diff_img)
        # cv2.imshow("Card_best_suit_diff_img",best_suit_diff_img)
        # cv2.resizeWindow("Card_best_rank_match_diff", 300, 125)
        # cv2.moveWindow("Card_best_rank_match_diff", 1000, 600)
        # cv2.resizeWindow("Card_best_suit_diff_img", 300, 125)
        # cv2.moveWindow("Card_best_suit_diff_img", 1000, 800)
        # cv2.waitKey(1)
...
def draw_results(image, qCard):
    ...
    cv2.putText(image,r_diff,(x+20,y+60),font,0.5,(0,0,255),1,cv2.LINE_AA)
    cv2.putText(image,s_diff,(x+20,y+80),font,0.5,(0,0,255),1,cv2.LINE_AA)
